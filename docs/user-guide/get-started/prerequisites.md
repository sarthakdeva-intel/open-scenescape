...
If you have not already, review the [System Requirements](./system-requirements.md) to ensure your system is compatible with Scenescape.
...
Once these prerequisites are met, proceed to [Get Started](../get-started.md#step-1-get-intel-scenescape) to set up and run Scenescape.
